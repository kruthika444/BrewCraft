...
class Reject implements HttpPostActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            $savedQuote = $this->quoteResponseService->reject(
                $quoteRequest,
                $customerId
            );
            ...
            $this->logger->error(
                'Unexpected customer quote rejection error.',
                [
            ...
            $this->messageManager->addErrorMessage(
                __('The quote proposal could not be rejected.')
            );
