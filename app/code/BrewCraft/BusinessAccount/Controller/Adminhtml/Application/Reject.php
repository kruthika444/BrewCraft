...
class Reject extends Action implements HttpPostActionInterface
{
    public const ADMIN_RESOURCE =
        'BrewCraft_BusinessAccount::application_reject';
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            $businessAccount = $this->approvalService->reject(
                $entityId,
                $adminComment
            );
            ...
            $this->messageManager->addSuccessMessage(
                __(
                    'The business application for "%1" has been rejected.',
            ...
            $this->messageManager->addErrorMessage(
                __('The business application could not be rejected.')
            );
        }
